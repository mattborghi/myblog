...
Basically the source code is in the current repo, named `website-source`, whereas the built Gatsby blog is located in `https://github.com/mattborghi/mattborghi.github.io`.
...
```json
"deploy": "gatsby build --prefix-paths && gh-pages -d public -b master -r https://github.com/mattborghi/mattborghi.github.io"
```
